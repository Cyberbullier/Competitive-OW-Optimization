...
class TeamDetectorTest(unittest.TestCase):
  @classmethod
  def setUpClass(cls):
    cls.smaller_screenshot = cv2.imread('/Users/theyoungkai/python_projects/overwatch_perfect_flex/sample-screenshots/smaller-screenshot.jpg')
    cls.cards_screen = cv2.imread('/Users/theyoungkai/python_projects/overwatch_perfect_flex/sample-screenshots/cards-screen.jpg')
